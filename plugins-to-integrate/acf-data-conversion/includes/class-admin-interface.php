<?php
/**
 * ACF Admin Interface Class - UPDATED VERSION
 * 
 * Handles the admin interface, form processing, and AJAX interactions.
 * Provides the user interface for all conversion operations.
 *
...
class BWS_ACF_Admin_Interface {
     ...
     * Constructor
     *
     * @param BWS_ACF_Field_Mapper $field_mapper Field mapper instance
     * @param BWS_ACF_Data_Processor $data_processor Data processor instance
     * @param BWS_ACF_Preview_System $preview_system Preview system instance
     */
    public function __construct( 
        BWS_ACF_Field_Mapper $field_mapper,
        BWS_ACF_Data_Processor $data_processor,
        BWS_ACF_Preview_System $preview_system
    ) {
        $this->components = [
    ...
    public function display_page(): void {
        ?>
        <div class="wrap bws-acf-conversion-wrap">
            <h1><?php esc_html_e( 'ACF Data Conversion Tool', 'acf-data-conversion' ); ?></h1>
            
            <?php $this->display_admin_notices(); ?>
            
            <div class="bws-acf-conversion-container">
                <?php $this->display_tabs(); ?>
                
                <div class="bws-acf-conversion-content">
    ...
    private function display_admin_notices(): void {
        ...
        if ( ! $this->is_acf_pro_available() ) {
            ...
            <div class="notice notice-error">
                <p>
                    <strong><?php esc_html_e( 'ACF Data Conversion Tool', 'acf-data-conversion' ); ?></strong><br>
                    <?php esc_html_e( 'Advanced Custom Fields Pro is required for this tool to function properly.', 'acf-data-conversion' ); ?>
                </p>
            </div>
            <?php
            return;
                ...
                <p>
                    ...
                    <?php if ( 'success' === $result ) : ?>
                        <a href="#" class="button button-secondary view-conversion-report" style="margin-left: 10px;">
                            <?php esc_html_e( 'View Conversion Report', 'acf-data-conversion' ); ?>
                        </a>
                    <?php endif; ?>
                </p>
            </div>
    ...
    private function display_tab_content(): void {
        switch ( $this->current_tab ) {
            case 'copy_data':
                $this->display_copy_data_tab();
                break;
                
            case 'map_data':
                $this->display_map_data_tab();
                break;
    ...
    private function display_copy_data_tab(): void {
        ?>
        <div class="bws-acf-conversion-tab-content">
            <div class="bws-acf-conversion-section">
                <h2><?php esc_html_e( 'Copy Data', 'acf-data-conversion' ); ?></h2>
                <p class="description">
                    <?php esc_html_e( 'Copy data as-is between ACF fields, or between taxonomy terms. Original data is preserved and copied to the target location.', 'acf-data-conversion' ); ?>
                </p>

                <form id="copy-data-form" class="bws-acf-conversion-form">
                    <?php wp_nonce_field( 'bws_acf_conversion_nonce', 'nonce' ); ?>
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="content_type"><?php esc_html_e( 'Content Type', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                                    <select name="content_type" id="content_type" class="regular-text" required>
                                        <option value=""><?php esc_html_e( 'Select content type...', 'acf-data-conversion' ); ?></option>
                                        <option value="posts"><?php esc_html_e( 'Posts', 'acf-data-conversion' ); ?></option>
                                        <option value="taxonomy_terms"><?php esc_html_e( 'Taxonomy Terms', 'acf-data-conversion' ); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e( 'Whether to work with posts or taxonomy terms.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
                            ...
                            <tr id="post_types_row" style="display: none;">
                                <th scope="row">
                                    <label for="post_types"><?php esc_html_e( 'Post Types', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                                    <?php $this->render_post_types_select(); ?>
                                    <p class="description"><?php esc_html_e( 'Select which post types to include.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
                            ...
                            <tr id="post_status_row" style="display: none;">
                                <th scope="row">
                                    <label for="post_status"><?php esc_html_e( 'Post Status', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                                    <?php $this->render_post_status_select(); ?>
                                    <p class="description"><?php esc_html_e( 'Select which post statuses to include.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
                            ...
                            <tr id="taxonomies_row" style="display: none;">
                                <th scope="row">
                                    <label for="taxonomies"><?php esc_html_e( 'Taxonomies', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                                    <?php $this->render_taxonomies_select(); ?>
                                    <p class="description"><?php esc_html_e( 'Select which taxonomies to include.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
							...
							echo '<tr id="copy_type_row" style="display: none;">
								<th scope="row">
									' . esc_html__( 'Copy Type', 'acf-data-conversion' ) . ' <span class="required">*</span>
								</th>
								<td>
									<fieldset>
										<label>
											<input type="radio" name="copy_type" value="field_to_field" id="copy_field_to_field" required>
											' . esc_html__( 'Between ACF Fields', 'acf-data-conversion' ) . '
										</label><br>
										<label>
											<input type="radio" name="copy_type" value="field_to_taxonomy" id="copy_field_to_taxonomy">
											' . esc_html__( 'ACF Field to Taxonomy Terms', 'acf-data-conversion' ) . '
										</label><br>
										<label>
											<input type="radio" name="copy_type" value="taxonomy_to_field" id="copy_taxonomy_to_field">
											' . esc_html__( 'Taxonomy Terms to ACF Field', 'acf-data-conversion' ) . '
										</label><br>
										<label>
											<input type="radio" name="copy_type" value="taxonomy_to_taxonomy" id="copy_taxonomy_to_taxonomy">
											' . esc_html__( 'Between Taxonomies', 'acf-data-conversion' ) . '
										</label>
									</fieldset>
									<p class="description">' . esc_html__( 'Choose the type of data copying operation.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							...
							echo '<tr id="source_field_row" style="display: none;">
								<th scope="row">
									<label for="source_field">' . esc_html__( 'Source Field', 'acf-data-conversion' ) . ' <span class="required">*</span></label>
								</th>
								<td>
									<select name="source_field" id="source_field" class="regular-text" data-conditional-required="field_to_field,field_to_taxonomy">
										<option value="">' . esc_html__( 'Select source field...', 'acf-data-conversion' ) . '</option>
									</select>
									<p class="description">' . esc_html__( 'Field containing the data to copy.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							...
							echo '<tr id="source_taxonomy_row" style="display: none;">
								<th scope="row">
									<label for="source_taxonomy">' . esc_html__( 'Source Taxonomy', 'acf-data-conversion' ) . ' <span class="required">*</span></label>
								</th>
								<td>
									<select name="source_taxonomy" id="source_taxonomy" class="regular-text" data-conditional-required="taxonomy_to_field,taxonomy_to_taxonomy">
										<option value="">' . esc_html__( 'Select source taxonomy...', 'acf-data-conversion' ) . '</option>
									</select>
									<p class="description">' . esc_html__( 'Taxonomy containing the terms to copy.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							...
							echo '<tr id="target_field_row" style="display: none;">
								<th scope="row">
									<label for="target_field">' . esc_html__( 'Target Field', 'acf-data-conversion' ) . ' <span class="required">*</span></label>
								</th>
								<td>
									<select name="target_field" id="target_field" class="regular-text" data-conditional-required="field_to_field,taxonomy_to_field">
										<option value="">' . esc_html__( 'Select target field...', 'acf-data-conversion' ) . '</option>
									</select>
									<p class="description">' . esc_html__( 'Field where the data will be copied.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							...
							echo '<tr id="target_taxonomy_row" style="display: none;">
								<th scope="row">
									<label for="target_taxonomy">' . esc_html__( 'Target Taxonomy', 'acf-data-conversion' ) . ' <span class="required">*</span></label>
								</th>
								<td>
									<select name="target_taxonomy" id="target_taxonomy" class="regular-text" data-conditional-required="field_to_taxonomy,taxonomy_to_taxonomy">
										<option value="">' . esc_html__( 'Select target taxonomy...', 'acf-data-conversion' ) . '</option>
									</select>
									<p class="description">' . esc_html__( 'Taxonomy where terms will be created/assigned.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							?>
                            ...
                            <tr id="term_assignment_row" style="display: none;">
                                <th scope="row">
                                    <?php esc_html_e( 'Term Assignment', 'acf-data-conversion' ); ?>
                                </th>
                                <td>
                                    <fieldset>
                                        <label>
                                            <input type="radio" name="append_terms" value="0" checked>
                                            <?php esc_html_e( 'Replace existing terms', 'acf-data-conversion' ); ?>
                                        </label><br>
                                        <label>
                                            <input type="radio" name="append_terms" value="1">
                                            <?php esc_html_e( 'Add to existing terms', 'acf-data-conversion' ); ?>
                                        </label>
                                    </fieldset>
                                    <p class="description"><?php esc_html_e( 'How to handle existing terms.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
                            ...
                            <tr id="batch_size_row" style="display: none;">
                                <th scope="row">
                                    <label for="batch_size"><?php esc_html_e( 'Batch Size', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                                    <input type="number" name="batch_size" id="batch_size" value="25" min="5" max="100" class="small-text">
                                    <p class="description"><?php esc_html_e( 'Number of items to process per batch.', 'acf-data-conversion' ); ?></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>

                    <div class="bws-acf-conversion-validation" id="copy-data-validation" style="display: none;">
                        <h3><?php esc_html_e( 'Validation Results', 'acf-data-conversion' ); ?></h3>
    ...
    private function display_map_data_tab(): void {
        ...
        <div class="bws-acf-conversion-tab-content">
            <div class="bws-acf-conversion-section">
                <h2><?php esc_html_e( 'Map Data', 'acf-data-conversion' ); ?></h2>
                <p class="description">
                    <?php esc_html_e( 'Transform option field values by mapping them to new values in another field or to taxonomy terms.', 'acf-data-conversion' ); ?>
                </p>

                <form id="map-data-form" class="bws-acf-conversion-form">
                    <?php wp_nonce_field( 'bws_acf_conversion_nonce', 'nonce' ); ?>
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <label for="map_content_type"><?php esc_html_e( 'Content Type', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                            ...
                            <tr id="map_post_types_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_post_types"><?php esc_html_e( 'Post Types', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                            ...
                            <tr id="map_post_status_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_post_status"><?php esc_html_e( 'Post Status', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                            ...
                            <tr id="map_taxonomies_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_taxonomies"><?php esc_html_e( 'Taxonomies', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                            ...
                            echo '<tr id="map_source_field_row" style="display: none;">
								<th scope="row">
									<label for="map_source_field">' . esc_html__( 'Source Field', 'acf-data-conversion' ) . ' <span class="required">*</span></label>
								</th>
								<td>
									<select name="source_field" id="map_source_field" class="regular-text" required>
										<option value="">' . esc_html__( 'Select source field...', 'acf-data-conversion' ) . '</option>
									</select>
									<p class="description">' . esc_html__( 'Option field containing values to map.', 'acf-data-conversion' ) . '</p>
								</td>
							</tr>';
							?>
                            ...
                            echo '<tr id="map_target_type_row" style="display: none;">
								<th scope="row">
									' . esc_html__( 'Map To', 'acf-data-conversion' ) . ' <span class="required">*</span>
								</th>
								<td>
									<fieldset>
										<label>
											<input type="radio" name="target_type" value="field" id="map_target_type_field" required>
											' . esc_html__( 'Another ACF Field', 'acf-data-conversion' ) . '
										</label><br>
										<label>
											<input type="radio" name="target_type" value="taxonomy" id="map_target_type_taxonomy">
											' . esc_html__( 'Taxonomy Terms', 'acf-data-conversion' ) . '
										</label>
									</fieldset>
								</td>
							</tr>';
                            ...
                            <tr id="map_target_field_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_target_field"><?php esc_html_e( 'Target Field', 'acf-data-conversion' ); ?> <span class="required">*</span></label>
                                </th>
                                <td>
                                    <select name="target_field" id="map_target_field" class="regular-text" data-conditional-required="field">
                                        <option value=""><?php esc_html_e( 'Select target field...', 'acf-data-conversion' ); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e( 'Field where mapped values will be stored.', 'acf-data-conversion' ); ?></p>
                                    
                                    <!-- Option Mappings for Field Target -->
                                    <div class="bws-acf-conversion-mappings" id="field-option-mappings" style="display: none; margin-top: 15px;">
                                        <h4><?php esc_html_e( 'Value Mappings', 'acf-data-conversion' ); ?></h4>
                                        <p class="description"><?php esc_html_e( 'Map each source option to a target field option.', 'acf-data-conversion' ); ?></p>
                                        <div class="unmapped-behavior-notice" style="background: #fff3cd; border: 1px solid #ffecb5; padding: 10px; margin: 10px 0; border-radius: 4px;">
                                            <strong><?php esc_html_e( 'Unmapped Values:', 'acf-data-conversion' ); ?></strong>
                                            <?php esc_html_e( 'Values without mappings will be skipped and not copied to the target field.', 'acf-data-conversion' ); ?>
                                        </div>
                            ...
                            <tr id="map_target_taxonomy_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_target_taxonomy"><?php esc_html_e( 'Target Taxonomy', 'acf-data-conversion' ); ?> <span class="required">*</span></label>
                                </th>
                                <td>
                                    <select name="target_taxonomy" id="map_target_taxonomy" class="regular-text" data-conditional-required="taxonomy">
                                        <option value=""><?php esc_html_e( 'Select target taxonomy...', 'acf-data-conversion' ); ?></option>
                                    </select>
                                    <p class="description"><?php esc_html_e( 'Taxonomy where terms will be created.', 'acf-data-conversion' ); ?></p>
                                    
                                    <!-- Term Assignment Options for Taxonomy Target -->
                                    <div id="taxonomy-term-assignment" style="display: none; margin-top: 15px;">
                                        <fieldset>
                                            <legend><?php esc_html_e( 'Term Assignment', 'acf-data-conversion' ); ?></legend>
                                            <label>
                                                <input type="radio" name="append_terms" value="0" checked>
                                                <?php esc_html_e( 'Replace existing terms', 'acf-data-conversion' ); ?>
                                            </label><br>
                                    ...
                                    <div class="bws-acf-conversion-mappings" id="taxonomy-option-mappings" style="display: none; margin-top: 15px;">
                                        <h4><?php esc_html_e( 'Value Mappings', 'acf-data-conversion' ); ?></h4>
                                        <p class="description"><?php esc_html_e( 'Map each source option to a taxonomy term.', 'acf-data-conversion' ); ?></p>
                                        <div class="unmapped-behavior-notice" style="background: #fff3cd; border: 1px solid #ffecb5; padding: 10px; margin: 10px 0; border-radius: 4px;">
                                            <strong><?php esc_html_e( 'Unmapped Values:', 'acf-data-conversion' ); ?></strong>
                                            <?php esc_html_e( 'Values without mappings will be skipped and no taxonomy terms will be assigned for those values.', 'acf-data-conversion' ); ?>
                                        </div>
                                        <div class="mappings-content"></div>
                                    </div>
                                </td>
                            ...
                            <tr id="map_batch_size_row" style="display: none;">
                                <th scope="row">
                                    <label for="map_batch_size"><?php esc_html_e( 'Batch Size', 'acf-data-conversion' ); ?></label>
                                </th>
                                <td>
                    ...
                    <div class="bws-acf-conversion-validation" id="map-data-validation" style="display: none;">
                        <h3><?php esc_html_e( 'Validation Results', 'acf-data-conversion' ); ?></h3>
                        <div class="validation-content"></div>
                    </div>
    ...
    private function render_action_buttons(): void {
        ?>
        <div class="bws-acf-conversion-actions">
            <button type="button" class="button button-secondary bws-preview-btn">
                <span class="dashicons dashicons-visibility"></span>
                <?php esc_html_e( 'Generate Preview', 'acf-data-conversion' ); ?>
            </button>
            
            <button type="submit" class="button button-primary bws-convert-btn" disabled>
                <span class="dashicons dashicons-update"></span>
                <?php esc_html_e( 'Start Copying', 'acf-data-conversion' ); ?>
            </button>

            <div class="bws-acf-conversion-status" style="display: none;">
    ...
    private function display_progress_modal(): void {
        ?>
        <div id="bws-acf-conversion-modal" class="bws-acf-modal" style="display: none;">
            <div class="bws-acf-modal-content">
                <div class="bws-acf-modal-header">
                    <h2 id="modal-title"><?php esc_html_e( 'Processing', 'acf-data-conversion' ); ?></h2>
                ...
                <div class="bws-acf-modal-body">
                    ...
                    <div class="status-messages">
                        ...
                        <div class="detailed-log" style="display: none;">
                            <h4><?php esc_html_e( 'Detailed Log', 'acf-data-conversion' ); ?></h4>
                ...
                <div class="bws-acf-modal-footer">
                    <button type="button" class="button button-secondary toggle-log">
                        <?php esc_html_e( 'Show Details', 'acf-data-conversion' ); ?>
                    </button>
                    <button type="button" class="button button-primary modal-close" style="display: none;">
                        <?php esc_html_e( 'Close', 'acf-data-conversion' ); ?>
                    </button>
                </div>
            </div>
        </div>
    ...
    private function display_report_modal(): void {
        ?>
        <div id="bws-acf-conversion-report-modal" class="bws-acf-modal" style="display: none;">
            <div class="bws-acf-modal-content">
                <div class="bws-acf-modal-header">
                    <h2><?php esc_html_e( 'Conversion Report', 'acf-data-conversion' ); ?></h2>
                    <button type="button" class="bws-acf-modal-close">&times;</button>
                </div>
    ...
    public function handle_conversion_ajax(): void {
        ...
        switch ( $conversion_type ) {
            ...
            default:
                $result = [
                    'success' => false,
                    'errors' => [ __( 'Invalid conversion type.', 'acf-data-conversion' ) ]
                ];
        }
    ...
    public function handle_preview_ajax(): void {
        ...
        switch ( $conversion_type ) {
            ...
            default:
                $result = [
                    'success' => false,
                    'error' => __( 'Invalid conversion type.', 'acf-data-conversion' )
                ];
        }
    ...
    public function handle_get_taxonomy_terms_ajax(): void {
        ...
        if ( ! $taxonomy || ! taxonomy_exists( $taxonomy ) ) {
            wp_send_json_error( __( 'Invalid taxonomy.', 'acf-data-conversion' ) );
        }
    ...
    public function handle_get_options_ajax(): void {
        ...
        if ( $field_key ) {
            ...
            wp_send_json_error( __( 'Field key is required.', 'acf-data-conversion' ) );
        }
    }
    ...
    private function render_post_types_select( string $field_id = 'post_types' ): void {
        ...
        <select name="post_types[]" id="<?php echo esc_attr( $field_id ); ?>" class="regular-text" multiple>
            <option value="any" selected><?php esc_html_e( 'All Post Types', 'acf-data-conversion' ); ?></option>
    ...
    private function render_post_status_select( string $field_id = 'post_status' ): void {
        ...
        <select name="post_status[]" id="<?php echo esc_attr( $field_id ); ?>" class="regular-text" multiple>
            <option value="publish" selected><?php esc_html_e( 'Published', 'acf-data-conversion' ); ?></option>
            <option value="draft"><?php esc_html_e( 'Draft', 'acf-data-conversion' ); ?></option>
            <option value="private"><?php esc_html_e( 'Private', 'acf-data-conversion' ); ?></option>
            <option value="pending"><?php esc_html_e( 'Pending', 'acf-data-conversion' ); ?></option>
        </select>
        <?php
    }
    ...
    private function render_taxonomies_select( string $field_id = 'taxonomies' ): void {
        ...
        <select name="taxonomies[]" id="<?php echo esc_attr( $field_id ); ?>" class="regular-text" multiple>
            <option value="any" selected><?php esc_html_e( 'All Taxonomies', 'acf-data-conversion' ); ?></option>
            <?php foreach ( $taxonomies as $taxonomy ) : ?>
                <option value="<?php echo esc_attr( $taxonomy['name'] ); ?>">
                    <?php echo esc_html( $taxonomy['label'] ); ?>
                    <?php if ( $taxonomy['hierarchical'] ) : ?>
                        (<?php esc_html_e( 'Hierarchical', 'acf-data-conversion' ); ?>)
                    <?php endif; ?>
                </option>
            <?php endforeach; ?>
        </select>
...
public function handle_estimate_conversion_size_ajax(): void {
    ...
    try {
        ...
        if ( ! in_array( $conversion_type, [ 'copy_data', 'map_data' ], true ) ) {
            ...
            wp_send_json_error( [ 
                'message' => sprintf( 
                    __( 'Invalid conversion type: %s. Expected copy_data or map_data.', 'acf-data-conversion' ), 
                    $conversion_type 
                )
            ] );
            return;
...
private function sanitize_conversion_config( array $raw_config ): array {
	...
	private function format_duration( int $seconds ): string {
		if ( $seconds < 60 ) {
			return sprintf( _n( '%d second', '%d seconds', $seconds, 'acf-data-conversion' ), $seconds );
		} elseif ( $seconds < 3600 ) {
			$minutes = intval( $seconds / 60 );
			$remaining_seconds = $seconds % 60;
			
			if ( $remaining_seconds === 0 ) {
				return sprintf( _n( '%d minute', '%d minutes', $minutes, 'acf-data-conversion' ), $minutes );
			} else {
				return sprintf( 
					__( '%d minutes, %d seconds', 'acf-data-conversion' ), 
					$minutes, 
					$remaining_seconds 
				);
			}
			...
			if ( $remaining_minutes === 0 ) {
				return sprintf( _n( '%d hour', '%d hours', $hours, 'acf-data-conversion' ), $hours );
			} else {
				return sprintf( 
					__( '%d hours, %d minutes', 'acf-data-conversion' ), 
					$hours, 
					$remaining_minutes 
				);
			}
