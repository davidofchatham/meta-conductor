...
class BWS_Admin_Columns_Integration {
...
add_action('bws_process_post_after_column_update', function($post_id) {
    $taxonomy_manager = BWS_Taxonomy_Manager::get_instance();
    $integration = new BWS_Admin_Columns_Integration($taxonomy_manager->get_handlers());
