...
class ConfigHelpers {
     ...
     * save 400s with `"1" is not a valid option`. Storage's read
     * projection additionally tolerates the map (legacy and hand-seeded data
     * carries it), but nothing should WRITE it.
     *
