...
class BWS_Condition_Evaluator {

    /**
     * Evaluate a condition against an entity
     *
     * @param BWS_Entity $entity Entity to evaluate
     ...
     *
     * @param BWS_Entity $entity Entity to check
     ...
     *
     * Simple version - will be replaced by full BWS_Date_Parser utility
     *
