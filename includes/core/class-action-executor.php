...
class ActionExecutor {
     ...
     * @param Entity|null $source_entity Source entity (for dynamic values)
     * @return bool Success
     */
     ...
     * @param Entity|null $source_entity Source entity
     * @return bool Success
     */
    ...
    protected function execute_inherit_parent_meta($entity, $action) {
        ...
        $parent_entity = new Entity('term', $term_obj->parent);
