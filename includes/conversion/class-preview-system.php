<?php
/**
 * Preview System Class
 *
 * Handles preview generation for data conversion operations.
 *
...
class PreviewSystem {
     ...
     * Constructor
     *
     * @param DataProcessor $data_processor Data processor instance
     */
    public function __construct( DataProcessor $data_processor ) {
    ...
    private function schedule_cleanup(): void {
        ...
        add_action( 'bws_meta_manager_conversion_cleanup', [ $this, 'cleanup_old_previews' ] );
    }
