...
class BWS_Conversion_Manager {
	...
	private function init_components(): void {
		...
		$this->field_mapper = new BWS_Field_Mapper();

		// Initialize Data Processor with Field Mapper
		$this->data_processor = new BWS_Data_Processor( $this->field_mapper );

		// Initialize Preview System with Data Processor
		$this->preview_system = new BWS_Preview_System( $this->data_processor );
	}
	 ...
	 *
	 * @return BWS_Field_Mapper
	 */
	public function get_field_mapper(): BWS_Field_Mapper {
	 ...
	 *
	 * @return BWS_Data_Processor
	 */
	public function get_data_processor(): BWS_Data_Processor {
	 ...
	 *
	 * @return BWS_Preview_System
	 */
	public function get_preview_system(): BWS_Preview_System {
