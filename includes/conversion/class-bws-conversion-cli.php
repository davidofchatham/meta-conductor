 ...
 */
class BWS_Conversion_CLI {

	/**
	 * Conversion manager instance
	 *
	 * @var BWS_Conversion_Manager
	 */
	private $manager;
	 ...
	 * Constructor
	 *
	 * @param BWS_Conversion_Manager $manager Conversion manager instance
	 */
	public function __construct( BWS_Conversion_Manager $manager ) {
	...
	public function test_term_migrator( $args, $assoc_args ) {
		...
		$migrator = new BWS_Term_Migrator();
	...
	public function test_field_converter( $args, $assoc_args ) {
		...
		$converter = new BWS_Field_Converter();
	...
	public function test_batch_processor( $args, $assoc_args ) {
		...
		$processor = new BWS_Batch_Processor();
